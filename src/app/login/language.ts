export class Language {
  static factory = {
    ...
    password_correctly: ['请输入正确的用户密码', 'Please Enter Correctly Password!'],
    login: ['登录', 'Login'],
    login_tips: ['登录操作', 'Login Response'],
    login_failed: ['您的登录失败，请确实账户密码是否正确', 'Your login failed. Please confirm that the account password is correct.'],
